...
public class InnerActivity extends FragmentActivity implements DatePickerDialog.OnDateSetListener, OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Statusbar.setStatusBarColor(InnerActivity.this, R.color.statusbar);
        ...
        cd = new ConnectionDetector(InnerActivity.this);
        lv.setAdapter(new Inneradapter(InnerActivity.this));
...
//                    price[i], listprice[i], i,pid[i]));
        ...
        ca.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!ca.getText().toString().trim().equals("Instant Book")) {
                    Toast.makeText(InnerActivity.this, "Checking availibility...", Toast.LENGTH_SHORT).show();
                    ...
                    handler1.postDelayed(new Runnable() {
                        ...
                        {
                            Toast.makeText(InnerActivity.this, "Availabl!", Toast.LENGTH_SHORT).show();
                    ...
                    new SweetAlertDialog(v.getContext(), SweetAlertDialog.SUCCESS_TYPE)
                            ...
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                ...
                                public void onClick(SweetAlertDialog sweetAlertDialog) {
                                    ...
                                    Intent intent=new Intent(InnerActivity.this,PayPal_sdk.class);
                    ...
                    Toast.makeText(InnerActivity.this, "Please select dates first!", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public View HorizontalList(int layout_name) {
        ...
        LayoutInflater layoutInflater =
                (LayoutInflater) InnerActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public void getthetracker(String clientLatitude, String clientLongitude) {
        ...
        MapsInitializer.initialize(InnerActivity.this);
        switch (GooglePlayServicesUtil.isGooglePlayServicesAvailable(InnerActivity.this)) {
...
//                    map.animateCamera(zoom);
                    ...
                    Toast.makeText(InnerActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
                }
            ...
            case ConnectionResult.SERVICE_MISSING:
                Toast.makeText(InnerActivity.this, "SERVICE MISSING", Toast.LENGTH_SHORT).show();
                break;
            case ConnectionResult.SERVICE_VERSION_UPDATE_REQUIRED:
                Toast.makeText(InnerActivity.this, "UPDATE REQUIRED", Toast.LENGTH_SHORT).show();
                break;
            default:
                Toast.makeText(InnerActivity.this, GooglePlayServicesUtil.isGooglePlayServicesAvailable(InnerActivity.this), Toast.LENGTH_SHORT).show();
        }
    ...
    public void onDateSet(DatePickerDialog view, int year, int monthOfYear, int dayOfMonth) {
        ...
        if(count==0){
            ...
            if (!date1.equals("")) {
                ...
                Toast.makeText(InnerActivity.this, "Please select From date first !!!", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public void openMail(View view) {
        ...
        emailintent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Regarding your property");
